...
import { VerifyEmailCard } from "@/components/onboarding/VerifyEmailCard";
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="space-y-6">
            <BenefitItem
              ...
              description="The code confirms only you have access to this email address. We never share it."
            />
            <BenefitItem
            ...
            <BenefitItem
              ...
              description="The code was sent to your signup email. Look in spam or promotions if you don’t see it."
            />
          </div>
        </div>
      }
